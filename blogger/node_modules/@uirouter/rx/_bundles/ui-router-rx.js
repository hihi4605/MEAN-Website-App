...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@uirouter/rx'] = {}, global.rxjs, global.operators));
    ...
    var UIRouterRx = /** @class */ (function () {
        function UIRouterRx(router) {
            ...
            var success$ = start$.pipe(operators.mergeMap(function (t) {
                return t.promise.then(function () { return t; }, function () { return null; });
            }), operators.filter(function (t) { return !!t; }));
