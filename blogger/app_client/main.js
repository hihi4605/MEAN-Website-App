...
let sendButton = document.querySelector(".btn-send"); // Update the selector to target the specific button class

if (sendButton) { // Check if the sendButton element exists
  ...
  console.error("Send button not found!"); // Log an error if the sendButton element is not found
}